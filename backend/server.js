...
// ====================================
const corsOptions = {
    origin: process.env.CORS_ORIGIN ? process.env.CORS_ORIGIN.split(',') : ['http://localhost:3000', 'http://localhost:5173', 'https://pharma-frontend-hkg6.onrender.com', 'http://localhost:5173', 'http://172.20.10.2:5173'],
    credentials: true,
